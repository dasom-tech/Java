...
public class mainClass {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//String substr = str10.substring(2, 5);  //[2]부터 [5]전까지
		String substr = str10.substring(4); //[4]부터 끝까지
		...
		boolean b1 = str13.contains("서울 "); // 서울null 이렇게 하면 없다고 나옴
